...
import in.selfproject.expensetrackerapi.repository.ExpenseRepository;
...
public class ExpenseServiceImpl implements ExpenseService {
	...
	public List<Expense> readByDate(Date startDate, Date endDate, Pageable page) {
		...
		return expenseRepository
				.findByUserIdAndDateBetween(userService.getLoggedInUser().getId(), startDate, endDate, page).toList();
	}
